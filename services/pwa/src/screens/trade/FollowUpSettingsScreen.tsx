  ...
  return (
    <Pressable onPress={() => onChange(!value)}>
      <View className="flex-row items-center justify-between py-1">
        ...
        <View className={`w-12 h-7 rounded-full px-0.5 justify-center ${value ? "bg-blue-600" : "bg-slate-200"}`}>
          <View className={`w-6 h-6 rounded-full bg-white ${value ? "translate-x-5" : ""}`} />
        </View>
      </View>
    </Pressable>
  );

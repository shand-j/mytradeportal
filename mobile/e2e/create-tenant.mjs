 ...
 *
 * Wraps `app.seed_admin_user` inside the API container, then logs in to obtain
 * an access token and resolves the tenant's public config for the 6-digit

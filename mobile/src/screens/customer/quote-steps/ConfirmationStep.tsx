...
export function ConfirmationStep({
...
}: StepPropsWithBusiness & { onDone: () => void; showCreateAccount?: boolean }) {
  ...
  const highConfidence =
    formData.media.length > 0 && formData.category !== "other" && formData.triage !== "emergency";
  ...
  return (
    <View style={styles.container}>
      ...
      {showCreateAccount ? (
        <Button testID="quote-create-account" title="Create account to track your quote" onPress={onDone} />
      ) : (

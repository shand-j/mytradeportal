...
Output: ``mobile/demo-video/<journey>.mp4`` (1080x1920, H.264, silent AAC).

Usage:
    python mobile/scripts/compose_demo_video.py --journey electrician
    python mobile/scripts/compose_demo_video.py --journey customer
"""
